...
source("RFplotter.r")
AL<-read.table('../data/RandomForest/AL.txt')
...
F_score<-function(predicted,groundtruth){ #Fscore, Presision,Recall. accept vectors of  predicted calssification and ground truth classification
